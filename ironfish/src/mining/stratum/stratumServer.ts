...
export class StratumServer {
  ...
  send(socket: net.Socket, method: 'mining.submitted', body: MiningSubmitedMessage): void
  ...
  submitReply (socket: net.Socket, result: boolean, msg: string): void {
    this.send(socket, 'mining.submitted', {result: result, error: msg})
  }
}
